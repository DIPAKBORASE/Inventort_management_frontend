...
import "./user_asset.css";

export default function Track_User_Asset() {
    ...
    return (
        <>
            ...
            {/* PO History Section */}
    <div className="user-asset-section">

        <div className="user-asset-search-box">
        <input type="text" placeholder="Search Item..." />
        <button className="user-asset-search-btn"><i className="fas fa-search"></i></button>
      </div>

      {/* Export to Excel Button */}
      <button className="user-asset-export-btn">Export to Excel</button>

      {/* Table */}
      <div className="scoller" >
      <table className="user-asset-table">
        <thead>
            <tr>
                <th colSpan={4}></th>
      ...
      <div className="user-asset-navigation">
        <button>First</button>
