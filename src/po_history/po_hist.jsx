...
export default function PO_History() {
    ...
    return (
        <>
            ...
            {/* PO History Section */}
            <div className="po-alert-section">
      ...
      {/* Table */}
      <table className="po-alert-table">
        <thead>
          <tr>
            <th>Sr.No.</th>
            <th>PO Number</th>
        ...
        <tbody>
          <tr>
            ...
            <i className="fas fa-download" style={{cursor:"pointer",marginRight:"20px"}}/>
