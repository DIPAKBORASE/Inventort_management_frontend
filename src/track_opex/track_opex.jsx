...
export default function Track_Opex() {
    ...
    return (
        <>
            ...
            {/* PO History Section */}
            <div className="track-opex-section">

        <div className="opex-row-disp">    
            <div className="track-opex-search-form">
        <label>Search:</label><br/>
        <input type="text" className="track-opex-search-input" placeholder="Search..." />
        <select className="track-opex-dropdown" placeholder="choose">
      ...
      <div className="track-opex-dateA-range-form">
        <label>From Date:</label><br/>
        <input type="date" className="track-opex-from-date" />
        </div>

        <div className="track-opex-dateB-range-form">
        <label>To Date:</label><br/>
        <input type="date" className="track-opex-to-date" />
       </div>
      ...
      <button className="track-opex-export-btn">Export to Excel</button>

      {/* Table */}
      <table className="track-opex-table">
        <thead>
          <tr>
            <th>Sr.No.</th>
            <th>Voucher No</th>
