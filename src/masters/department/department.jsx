...
export default function Department() {
    ...
    <div className="department-section">
        <div className="department-row-disp" style={{marginLeft:"-20px"}}>   
            
            <div className="department-form-field" >
                <label style={{color:"black"}}>Department<span style={{ color: 'red' }}>*</span></label>
                <input type="text" placeholder="enter  dpearmtent.." />
            </div>

            <div className="department-form-field" >
                <label style={{color:"black"}}>Cost Center<span style={{ color: 'red' }}>*</span></label>
        ...
        <div className="department-form-field">
            <button type="submit" style={{ backgroundColor: "#afa24c",marginTop:"10px", 
             marginLeft:"0px" , width:"15%", padding:"5px" , fontSize:"14px" }}>
              Submit
            </button>
        </div>
      ...
      <h3 style={{marginLeft:"30px"}}>Issue Type List</h3>
     ...
     <div className="search-box" style={{marginLeft:"30px", width:"25%" , marginTop:"1px"}}>
      ...
      <button className="department-export-btn">Export to Excel</button>
