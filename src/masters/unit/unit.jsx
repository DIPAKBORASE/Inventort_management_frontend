...
export default function Unit() {
    ...
    <div className="unit-section">
        <div className="unit-row-disp" style={{marginLeft:"-20px"}}>   
    ...
    <hr style={{marginLeft:"30px"}}/>
      ...
      <h2 style={{marginLeft:"30px"}}>Unit List</h2>

     <div className="search-box" style={{marginLeft:"30px", width:"45%" , marginTop:"1px"}}>
        <input type="text" placeholder="Search Item..." />
        <button className="search-btn" style={{width:"20%"}}><i className="fas fa-search"></i></button>
      </div>

      {/* Export to Excel Button */}
      <button className="unit-export-btn">Export to Excel</button>
