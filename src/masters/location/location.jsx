...
export default function Location() {
    ...
    <div className="location-section">
        <div className="location-row-disp" style={{marginLeft:"-110px"}}>   
    
        <div className="location-search-box">
        <label>ALT CODE:</label>
        <input type="text" className="location-search-input" placeholder="enter alt code.." />
        </div>
          

       <div className="location-form-field" >
         <label style={{color:"black"}}>Office Name<span style={{ color: 'red' }}>*</span></label>
    ...
    <div className="location-row-disp" style={{marginLeft:"120px"}}>
        <div className="location-form-field" style={{}}>
          ...
          <div className="location-form-field" style={{}}>
            <label style={{color:"black",marginLeft:"20px"}}>City<span style={{ color: 'red' }}>*</span></label>
              <input type="text" placeholder="enter price.." />
          </div>    
    </div>

    <div className="location-row-disp" >
                <div className="product-form-field" style={{marginLeft: "180px"}}>
     ...
     <div className="search-box" style={{marginLeft:"180px", width:"20%" , marginTop:"4px"}}>
      ...
      <button className="location-export-btn">Export to Excel</button>
