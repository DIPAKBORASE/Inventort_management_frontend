...
import "./disp_hist.css";

export default function Disp_Hist() {
    ...
    const toggleMastersDropdown = () => {
      ...
      return(
        ...
        <div className="dispatch-history-section">

        <div className="dispsearch-box">
        <input type="text" placeholder="Search Item..." />
        <button className="dispsearch-btn"><i className="fas fa-search"></i></button>
      </div>

      {/* Export to Excel Button */}
      <button className="dispexport-btn">Export to Excel</button>

      {/* Table */}
      <table className="disphistory-table">
        <thead>
          <tr>
            <th>Sr. No.</th>
            <th>Gate Pass No</th>
        ...
        <tbody>
          <tr>
            ...
            <td>Location A</td>
            <td>Location B</td>
            <td>Dept 1 / Cost Center 1</td>
            <td>John Doe</td>
            <td>Transport Mode</td>
            <td>10</td>
            <td><i className="fas fa-i" style={{cursor:"pointer", marginRight:"10px"}} />
            <i className="fas fa-trash" style={{cursor:"pointer", marginRight:"10px"}}/>
