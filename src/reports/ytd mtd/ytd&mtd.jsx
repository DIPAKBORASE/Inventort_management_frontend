...
export default function YTD_MTD() {
    ...
    return (
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.00" />
            ...
            {/* PO History Section */}
            <div className="ytd_mtd-section">
    <div className="ytd_mtd-row-disp">   
        <div className="ytd_mtd-search-box">
        <label>Search:</label>
        <input type="text" placeholder="Search Item..." />
        <button className="ytd_mtd-search-btn"><i className="fas fa-search"></i></button>
        </div>

        
      <div className="ytd_mtd-form-field" style={{marginRight:"-50px"}}>
        <label>Deparment<span style={{ color: 'red' }}>*</span></label>
           <select required>
            <option value="">Choose Deparment</option>
            <option value="vadodra">Accounts</option>
            {/* Add locations dynamically or hardcode */}
            </select>
      </div>

      <div className="ytd_mtd-form-field" style={{marginLeft:"-230px"}}>
      ...
      <div className="ytd_mtd-form-field" style={{marginLeft:"-310px"}}>
      ...
      <button className="ytd_mtd-export-btn">Export to Excel</button>

      {/* Table */}
      <table className="ytd_mtd-table">
        <thead>
          <tr>
