...
export default function Consump_Report() {
    ...
    return (
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.00" />
            ...
            {/* PO History Section */}
            <div className="consump-section">
    <div className="consump-row-disp">   
        <div className="consump-search-box">
        <label>Search:</label>
        <input type="text" placeholder="Search Item..." />
        <button className="consump-search-btn"><i className="fas fa-search"></i></button>
        </div>

        
      <div className="consump-form-field" style={{marginRight:"-15px"}}>
      ...
      <div className="consump-form-field" style={{marginLeft:"-335px"}}>
      ...
      <div className="consump-form-field" style={{marginLeft:"-380px"}}>
        <label>Location<span style={{ color: 'red' }}>*</span></label>
           <select required>
            <option value="">Choose Location</option>   
            <option value="IT">Navsari</option>
            {/* Add locations dynamically or hardcode */}
            </select>
      </div>

      <div className="consump-dateA-range-form">
        <label>From Date:</label><br/>
        <input type="date" className="material-from-date" />
        </div>

        <div className="consump-dateB-range-form">
    ...
    <div className="consump-circle-select">
  <p>Type:</p><br/>
  <label htmlFor="dateWise">
    <input
      ...
      name="radioOptions"
      value="dateWise"
      checked={selectedRadioOption === "dateWise"}
      onChange={() => setSelectedRadioOption("dateWise")}
    />
    Date Wise
  </label>
  ...
  <label htmlFor="consolidate">
    <input
      ...
      name="radioOptions"
      value="consolidate"
      checked={selectedRadioOption === "consolidate"}
      onChange={() => setSelectedRadioOption("consolidate")}
    />
    Consolidate
  </label>
</div>
      ...
      {/* Table */}
      {selectedRadioOption === "dateWise" && (
            <>
              {/* Date Wise Table */}
          
                {/* Export to Excel Button */}
            <button className="consump-export-btn">Export to Excel</button>
              <table className="consump-table">
        <thead>
          <tr>
            <th>Sr.No.</th>
            <th>Entry No.</th>
      ...
      <div className="material-navigation">
        ...
        <select>
          ...
          {selectedRadioOption === "consolidate" && (
