...
import "./matrl_recpt.css";
import { Link } from "react-router-dom";


export default function Material_Receipt() {
    ...
    <div className="material-row-disp">   
        <div className="material-search-box">
        <label>Search:</label>
        <input type="text" placeholder="Search Item..." />
        <button className="material-search-btn"><i className="fas fa-search"></i></button>
        </div>

        
      <div className="material-form-field" style={{marginRight:"-50px"}}>
        <label>Vendor<span style={{ color: 'red' }}>*</span></label>
           <select required>
            <option value="">Choose Vendor</option>
            <option value="vadodra">iCell</option>
            {/* Add locations dynamically or hardcode */}
            </select>
      </div>

      <div className="material-form-field" style={{marginLeft:"-320px"}}>
        <label>Group<span style={{ color: 'red' }}>*</span></label>
           <select required>
            <option value="">Choose Group</option>   
            <option value="IT">CCTV Camera</option>
            {/* Add locations dynamically or hardcode */}
            </select>
      </div>

      <div className="material-dateA-range-form">
        <label>From Date:</label><br/>
        <input type="date" className="material-from-date" />
        </div>

        <div className="material-dateB-range-form">
      ...
      <button className="material-export-btn">Export to Excel</button>
