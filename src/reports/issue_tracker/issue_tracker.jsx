...
export default function Issue_Tracker() {
    ...
    <div className="issue-row-disp">   
        <div className="issue-search-box">
        <label>Search:</label>
        <input type="text" placeholder="Search Item..." />
        <button className="issue-search-btn"><i className="fas fa-search"></i></button>
        </div>

        
      <div className="issue-form-field" style={{marginRight:"30px"}}>
      ...
      <div className="issue-form-field" style={{marginLeft:"-320px"}}>
      ...
      <div className="issue-form-field" style={{marginLeft:"-320px"}}>
        <label>Status<span style={{ color: 'red' }}>*</span></label>
           <select required>
            ...
            <option value="IT">Close</option>
            {/* Add locations dynamically or hardcode */}
            </select>
      </div>

      <div className="issue-dateA-range-form">
        <label>From Date:</label><br/>
        <input type="date" className="issue-from-date" />
        </div>

        <div className="issue-dateB-range-form">
        <label>To Date:</label><br/>
        <input type="date" className="issue-to-date" />
     </div>
      ...
      <button className="issue-export-btn">Export to Excel</button>
